    ...
    public unsafe partial struct ISizeableStream : INativeGuid, INativeVtbl
    {
        ...
        public ComResult getStreamSize(long* size)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.ISizeableStream*, long*, int>)Vtbl[3])(__self__, size);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
        ...
        public ComResult setStreamSize(long size)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.ISizeableStream*, long, int>)Vtbl[4])(__self__, size);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
    ...
    public unsafe partial struct ICloneable : INativeGuid, INativeVtbl
    {
        ...
        public LibVst.FUnknown* clone()
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.ICloneable*, LibVst.FUnknown*>)Vtbl[3])(__self__);
                __evt__.Dispose();
                return __result__;
            }
            else
    ...
    public unsafe partial struct IString : INativeGuid, INativeVtbl
    {
        ...
        public void setText8(byte* text)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                ((delegate*unmanaged[MemberFunction]<LibVst.IString*, byte*, void>)Vtbl[3])(__self__, text);
                __evt__.Dispose();
            }
            else
            {
        ...
        public void setText16(char* text)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                ((delegate*unmanaged[MemberFunction]<LibVst.IString*, char*, void>)Vtbl[4])(__self__, text);
                __evt__.Dispose();
            }
            else
            {
        ...
        public byte* getText8()
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IString*, byte*>)Vtbl[5])(__self__);
                __evt__.Dispose();
                return __result__;
            }
            else
        ...
        public char* getText16()
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IString*, char*>)Vtbl[6])(__self__);
                __evt__.Dispose();
                return __result__;
            }
            else
        ...
        public void take(void* s, byte isWide)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                ((delegate*unmanaged[MemberFunction]<LibVst.IString*, void*, byte, void>)Vtbl[7])(__self__, s, isWide);
                __evt__.Dispose();
            }
            else
            {
        ...
        public byte isWideString()
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IString*, byte>)Vtbl[8])(__self__);
                __evt__.Dispose();
                return __result__;
            }
            else
    ...
    public unsafe partial struct IUpdateHandler : INativeGuid
    {
        ...
        public ComResult addDependent(LibVst.FUnknown* @object, LibVst.IDependent* dependent)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IUpdateHandler*, LibVst.FUnknown*, LibVst.IDependent*, int>)Vtbl[3])(__self__, @object, dependent);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
        ...
        public ComResult removeDependent(LibVst.FUnknown* @object, LibVst.IDependent* dependent)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IUpdateHandler*, LibVst.FUnknown*, LibVst.IDependent*, int>)Vtbl[4])(__self__, @object, dependent);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
        ...
        public ComResult triggerUpdates(LibVst.FUnknown* @object, int message)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IUpdateHandler*, LibVst.FUnknown*, int, int>)Vtbl[5])(__self__, @object, message);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
        ...
        public ComResult deferUpdates(LibVst.FUnknown* @object, int message)
        {
            if (InteropHelper.IsTracerEnabled)
            {
                ...
                var __result__ = ((delegate*unmanaged[MemberFunction]<LibVst.IUpdateHandler*, LibVst.FUnknown*, int, int>)Vtbl[6])(__self__, @object, message);
                __evt__.Result = __result__;
                __evt__.Dispose();
                return __result__;
            }
